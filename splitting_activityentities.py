"""
Preping activityet annotations and creating meta_all.json output file
"""
...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset_root', type=str, default='/annotations/data/', help='dataset root directory')
    parser.add_argument('--corenlp_path', type=str, default='/annoa', help='path to stanford core nlp toolkit')
