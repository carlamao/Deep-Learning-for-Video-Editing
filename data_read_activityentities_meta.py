"""
Read activityNet Entities metadata.
"""
import json
import re
...
def main():
    ...
    path_dataset = Path(path_data) 
    captions_path = Path("annotations") / "data"
